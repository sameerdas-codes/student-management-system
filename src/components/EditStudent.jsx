    ...
    <section className="add-student-page">
      ...
      <div className="add-student-layout">
        ...
        <div className="student-info-card">
          ...
          <p>
            Personal identity details are protected.
            You can update academic information.
          </p>
          ...
          <div className="info-list">
            ...
            <div className="info-item">
              ...
              <div>
                ...
                <small>
                  Update the student's current academic details
                </small>
        ...
        <div className="add-student-card">
          ...
          <div className="add-student-header">
            ...
            <div>
              ...
              <p>
                Update the editable details below.
              </p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <small className="input-hint">
                B.Tech students can have a branch.
                Other courses do not require one.
              </small>
